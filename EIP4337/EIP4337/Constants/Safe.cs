...
{
    public interface ISafeConstant
{
    Dictionary<string, string> MultiSend { get; }
}

    public class Safe : ISafeConstant
    {
        public Dictionary<string, string> MultiSend { get; } = new Dictionary<string, string>
        {
