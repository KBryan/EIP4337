...
namespace EIP4337
{
    ...
    {
        const string signingKey = "ADD_SIGNING_KEY";
        const string rpcUrl = "https://api.stackup.sh/v1/node/STACKUP_NODE";
        static BigInteger chainIdArbitrum = 1482601649;
        const string contractAddress = "0x0dB8dA9D41F6F0663559804A499Cf5842694D6aF";

        const string mintingABI =
        ...
        public static async Task Main(string[] args)
        {
            ...
            _account = new Account(new EthECKey(signingKey), new BigInteger(5));
            ...
            var jsonRpcRequestSponsorUserOperation = new JsonRpcRequest
            {
                ...
                Params = new object[]
                    { userOperationParams, "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789", new { type = "payg" } }
            };
